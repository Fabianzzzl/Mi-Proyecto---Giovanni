...
class Formateadores:
    ...
    def formatear_producto_tabla(producto: Producto) -> str:
        ...
        return f"| {producto.id_producto:>6} | {producto.nombre:<28} | {Formateadores.formatear_precio(producto.precio):>8.2f} | {producto.cantidad:>6} | {producto.calcular_valor_total():>10.2f} |"
